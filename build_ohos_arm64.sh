...
make clean
make -j32 HOST_CC="gcc" CFLAGS="-fPIC" XCFLAGS=-DLUAJIT_DISABLE_JIT DYNAMIC_CC=${dynamic_cc} TARGET_LD=${target_ld} STATIC_CC=${static_cc} TARGET_AR="${target_ar}" TARGET_STRIP=${target_strip} 
